...
public class OI {
    ...
    public JoystickButton waitForButton;
    public JoystickButton open;
    public JoystickButton pinch;
    ...
    public OI() {
        ...
        spitOut = new JoystickButton(joystick2, 2);
        spitOut.whileHeld(new CommandBallPickUpReverse());
        pickUp = new JoystickButton(joystick2, 1);
        pickUp.whileHeld(new CommandBallPickUpForward());
        joystick = new Joystick(0);
        
        pinch = new JoystickButton(joystick, 12);
        pinch.whileHeld(new Pinch());
        open = new JoystickButton(joystick, 11);
        open.whileHeld(new Open());
        waitForButton = new JoystickButton(joystick, 1);
        waitForButton.whileHeld(new WaitForButton());
