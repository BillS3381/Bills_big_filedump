...
public class RobotMap {
    ...
    public static Encoder driveTraindriveEncoder1;
    public static Encoder driveTraindriveEncoder2;
    ...
    public static void init() {
        ...
        driveTraindriveEncoder1 = new Encoder(6, 7, false, EncodingType.k4X);
        LiveWindow.addSensor("DriveTrain", "driveEncoder1", driveTraindriveEncoder1);
        driveTraindriveEncoder1.setDistancePerPulse(1.0);
        driveTraindriveEncoder1.setPIDSourceType(PIDSourceType.kRate);
        driveTraindriveEncoder2 = new Encoder(8, 9, false, EncodingType.k4X);
        LiveWindow.addSensor("DriveTrain", "driveEncoder2", driveTraindriveEncoder2);
        driveTraindriveEncoder2.setDistancePerPulse(1.0);
        driveTraindriveEncoder2.setPIDSourceType(PIDSourceType.kRate);
